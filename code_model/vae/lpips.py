"""LPIPS (stripped) implementation used by VQGAN.

Adapted from the repo's `taming/modules/losses/lpips.py`.
"""
...
class LPIPS(nn.Module):
    def __init__(self, use_dropout: bool = True, ckpt_root: str = None, **kwargs):
        super().__init__()
        ...
        if ckpt_root is None:
            ckpt_root = "./file_dataset/weights/lpips"  # relative default
    ...
    def load_from_pretrained(self, name: str = "vgg_lpips"):
        ckpt = get_ckpt_path(name, self._ckpt_root)
